...
int main()
{
    printf("\n");
    printf("\t");
    printf(RED BOLD "-" END END);
    printf(GREEN BOLD "-" END END);
    printf(YELLOW BOLD "-" END END);
    printf(BLUE BOLD "-" END END);
    printf(MAGENTA BOLD "-" END END);
    printf(WHITE BOLD "-" END END);
    printf(CYAN BOLD "-" END END);
    printf(GREEN BOLD "-" END END);
    printf(YELLOW BOLD "-" END END);
    printf(BLUE BOLD "- " END END);
    printf(RED BOLD "WeLcOme" END END);
    printf(GREEN BOLD " To" END END);
    printf(YELLOW BOLD " OuR" END END);
    printf(BLUE BOLD " eLeArNiNg" END END);
    printf(MAGENTA BOLD " MaNaGeMeNt" END END);
    printf(CYAN BOLD " SySteM" END END);
    printf(RED BOLD " -" END END);
    printf(GREEN BOLD "-" END END);
    printf(YELLOW BOLD "-" END END);
    printf(BLUE BOLD "-" END END);
    ...
    printf("\n");
    printf("\t\t\t\t");
    printf(CYAN BOLD "1.Admin." END END);
    printf("\n");
    printf("\t\t\t\t");
    printf(CYAN BOLD "2.User." END END);
    printf("\n");
    printf("\t\t\t\t");
    ...
    login_user:
        ...
        if (person_check == 1)
        {
            ...
            if (student_check3 == 1)
            {
                ...
                printf("\t\t\t\tFinal : %s\n" END, student_arr[student_index1].result.final);
                printf(MAGENTA "\n\t\t\t\t-----Thank You-----\n\n" END);
            }
            else
            {
